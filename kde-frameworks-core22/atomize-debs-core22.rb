...
config.name = 'kde-frameworks-5-101-qt-5-15-8-core22'
...
slot.content = 'kde-frameworks-5-101-qt-5-15-8-core22-all'
slot.interface = 'content'
slot.read = %w[.]
config.slots['kde-frameworks-5-101-qt-5-15-8-core22-slot'] = slot
...
config.name = 'kde-frameworks-5-101-qt-5-15-8-core22-sd'
