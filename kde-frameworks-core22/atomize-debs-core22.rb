# New frameworks content pack on core22. Build 1
...
config.name = 'kf5-5-108-qt-5-15-10-core22'
...
slot.content = 'kf5-5-108-qt-5-15-10-core22-all'
slot.interface = 'content'
slot.read = %w[.]
config.slots['kf5-5-108-qt-5-15-10-core22-slot'] = slot
...
kf5_version = 'kf5-5-108'
qt5_version = 'qt-5-15-10'
...
config.name = 'kf5-5-108-qt-5-15-10-core22-sdk'
